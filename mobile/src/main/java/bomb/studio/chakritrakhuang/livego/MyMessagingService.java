...
package bomb.studio.chakritrakhuang.livego;
...
public class MyMessagingService extends Service {
    public static final String READ_ACTION =
            "bomb.studio.chakritrakhuang.livego.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "bomb.studio.chakritrakhuang.livego.ACTION_MESSAGE_REPLY";
